@echo off
title Quasar Permanent Spoofer
:internettest
cls
...
AMIDEWINx64.EXE /OS 2 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 3 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 4 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 5 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 6 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 7 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 8 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 9 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 10 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /OS 11 %RaNdOm%%RaNdOm%%RaNdOm%%RaNdOm%
